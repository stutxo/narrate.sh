...
var Me={symbols:Array.from("$;:,.!?\xA1\xBF\u2014\u2026\u201C\xAB\xBB\u201D\u201E ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz\u0251\u0250\u0252\xE6\u0253\u0299\u03B2\u0254\u0255\xE7\u0257\u0256\xF0\u02A4\u0259\u0258\u025A\u025B\u025C\u025D\u025E\u025F\u0284\u0261\u0260\u0262\u029B\u0266\u0267\u0127\u0265\u029C\u0268\u026A\u029D\u026D\u026C\u026B\u026E\u029F\u0271\u026F\u0270\u014B\u0273\u0272\u0274\xF8\u0275\u0278\u03B8\u0153\u0276\u0298\u0279\u027A\u027E\u027B\u0280\u0281\u027D\u0282\u0283\u0288\u02A7\u0289\u028A\u028B\u2C71\u028C\u0263\u0264\u028D\u03C7\u028E\u028F\u0291\u0290\u0292\u0294\u02A1\u0295\u02A2\u01C0\u01C1\u01C2\u01C3\u02C8\u02CC\u02D0\u02D1\u02BC\u02B4\u02B0\u02B1\u02B2\u02B7\u02E0\u02E4\u02DE\u2193\u2191\u2192\u2197\u2198'\u0329'\u1D7B"),voiceAliases:{Bella:"expr-voice-2-f",Jasper:"expr-voice-2-m",Luna:"expr-voice-3-f",Bruno:"expr-voice-3-m",Rosie:"expr-voice-4-f",Hugo:"expr-voice-4-m",Kiki:"expr-voice-5-f",Leo:"expr-voice-5-m"},sampleRate:24e3};var We=class{buffer;view;constructor(i){this.buffer=new Uint8Array(i),this.view=new DataView(i)}parseInitializers(){let i=new Map,s=this.findField(this.buffer,0,this.buffer.length,7);if(!s)throw new Error("Could not find graph in ONNX model");let e=s.start;for(;e<s.end;){let t=this.readTag(e);if(!t)break;if(t.fieldNumber===5&&t.wireType===2){let r=this.readVarint(t.dataStart),u=r.end,n=u+r.value,f=this.parseTensorProto(u,n);f&&f.name&&i.set(f.name,f),e=n}else e=this.skipField(t)}return i}parseTensorProto(i,s){let e="",t=[],r=0,u=null,n=null,f=null,o=null,a=i;for(;a<s;){let c=this.readTag(a);if(!c)break;switch(c.fieldNumber){case 1:if(c.wireType===0){let d=this.readVarint(c.dataStart);t.push(d.value),a=d.end}else if(c.wireType===2){let d=this.readVarint(c.dataStart),p=d.end,m=p+d.value;for(;p<m;){let g=this.readVarint(p);t.push(g.value),p=g.end}a=m}else a=this.skipField(c);break;case 2:{let d=this.readVarint(c.dataStart);r=d.value,a=d.end}break;case 4:if(c.wireType===2){let d=this.readVarint(c.dataStart),p=d.end,m=this.buffer.slice(p,p+d.value);n=new Float32Array(m.buffer,0,d.value/4),a=p+d.value}else a=this.skipField(c);break;case 5:if(c.wireType===2){let d=this.readVarint(c.dataStart),p=d.end,m=p+d.value,g=[],v=p;for(;v<m;){let b=this.readVarint(v);g.push(b.value|0),v=b.end}f=new Int32Array(g),a=m}else if(c.wireType===0){let d=this.readVarint(c.dataStart);f=new Int32Array([d.value]),a=d.end}else a=this.skipField(c);break;case 7:if(c.wireType===2){let d=this.readVarint(c.dataStart),p=d.end,m=this.buffer.slice(p,p+d.value);o=new BigInt64Array(m.buffer,0,d.value/8),a=p+d.value}else a=this.skipField(c);break;case 8:{let d=this.readVarint(c.dataStart),p=this.buffer.subarray(d.end,d.end+d.value);e=new TextDecoder().decode(p),a=d.end+d.value}break;case 9:{let d=this.readVarint(c.dataStart);u=this.buffer.subarray(d.end,d.end+d.value),a=d.end+d.value}break;default:a=this.skipField(c)}}if(!e)return null;let l;return u?l=u:n?l=new Uint8Array(n.buffer,n.byteOffset,n.byteLength):f?l=new Uint8Array(f.buffer,f.byteOffset,f.byteLength):o?l=new Uint8Array(o.buffer,o.byteOffset,o.byteLength):l=new Uint8Array(0),{name:e,dims:t,dataType:r,rawData:l}}readTag(i){if(i>=this.buffer.length)return null;let s=this.readVarint(i),e=s.value;return{fieldNumber:e>>>3,wireType:e&7,dataStart:s.end}}readVarint(i){let s=0,e=0,t=i;for(;t<this.buffer.length;){let r=this.buffer[t];if(s|=(r&127)<<e,t++,(r&128)===0||(e+=7,e>35))break}return{value:s,end:t}}skipField(i){switch(i.wireType){case 0:return this.readVarint(i.dataStart).end;case 1:return i.dataStart+8;case 2:{let s=this.readVarint(i.dataStart);return s.end+s.value}case 5:return i.dataStart+4;default:throw new Error(`Unknown wire type: ${i.wireType}`)}}findField(i,s,e,t){let r=s;for(;r<e;){let u=this.readTag(r);if(!u)break;if(u.fieldNumber===t&&u.wireType===2){let n=this.readVarint(u.dataStart);return{start:n.end,end:n.end+n.value}}r=this.skipField(u)}return null}};function ot(h){let i=new Float32Array(h.length);for(let s=0;s<h.length;s++){let e=h[s],t=e>>15&1,r=e>>10&31,u=e&1023;r===0?i[s]=(t?-1:1)*Math.pow(2,-14)*(u/1024):r===31?i[s]=u===0?t?-1/0:1/0:NaN:i[s]=(t?-1:1)*Math.pow(2,r-15)*(1+u/1024)}return i}async function At(h){let i=new Uint8Array(h),s=new Map,e=0;for(;e<i.length-4&&!(i[e]!==80||i[e+1]!==75||i[e+2]!==3||i[e+3]!==4);){let t=new DataView(h,e),r=t.getUint16(8,!0),u=t.getUint32(18,!0),n=t.getUint16(26,!0),f=t.getUint16(28,!0),o=new TextDecoder().decode(i.subarray(e+30,e+30+n));if(u===4294967295){let l=e+30+n,c=l+f;for(;l+4<=c;){let d=new DataView(h,l),p=d.getUint16(0,!0),m=d.getUint16(2,!0);if(p===1&&m>=16){let g=d.getUint32(12,!0),v=d.getUint32(16,!0);u=g+v*4294967296;break}l+=4+m}}let a=e+30+n+f;if(o.endsWith(".npy")&&r===0){let l=i.subarray(a,a+u),c=Jr(l.buffer,l.byteOffset),d=o.replace(".npy","");s.set(d,c)}e=a+u}return s}function Jr(h,i){let s=ei(h,i);return{shape:s.shape,data:s.data}}function ei(h,i=0){let s=new Uint8Array(h,i);if(s[0]!==147||s[1]!==78)throw new Error("Invalid .npy magic number");let e=s[6],t,r;e===1?(t=new DataView(h,i+8).getUint16(0,!0),r=10):(t=new DataView(h,i+8).getUint32(0,!0),r=12);let u=new TextDecoder().decode(s.subarray(r,r+t)),n=r+t,f=u.match(/shape['"]\s*:\s*\(([^)]*)\)/),o=f?f[1].split(",").map(p=>p.trim()).filter(p=>p).map(Number):[],a=u.match(/descr['"]\s*:\s*'([^']*)'/),l=a?a[1]:"<f4",c=o.length===0?1:o.reduce((p,m)=>p*m,1),d;if(l==="<f4"||l==="=f4"||l==="float32"){let p=new Uint8Array(h,i+n,c*4),m=new Uint8Array(c*4);m.set(p),d=new Float32Array(m.buffer)}else if(l==="<f2"||l==="=f2"||l==="float16"){let p=new Uint8Array(h,i+n,c*2),m=new Uint8Array(c*2);m.set(p);let g=new Uint16Array(m.buffer);d=ot(g)}else if(l==="<i8"||l==="=i8"||l==="int64"){let p=new Uint8Array(h,i+n,c*8),m=new Uint8Array(c*8);m.set(p);let g=new DataView(m.buffer);d=new Float32Array(c);for(let v=0;v<c;v++)d[v]=g.getInt32(v*8,!0)}else throw new Error(`Unsupported .npy dtype: ${l}`);return{shape:o,data:d,dtype:l}}var zt=`
